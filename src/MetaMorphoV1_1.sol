...
import {MulticallUpgradeable} from "../lib/openzeppelin-upgradeable/contracts/utils/MulticallUpgradeable.sol";
import {Ownable2StepUpgradeable} from "../lib/openzeppelin-upgradeable/contracts/access/Ownable2StepUpgradeable.sol";
import {ERC20PermitUpgradeable} from
    "../lib/openzeppelin-upgradeable/contracts/token/ERC20/extensions/ERC20PermitUpgradeable.sol";
import {
    IERC20,
    IERC4626,
    ERC20Upgradeable,
    ...
    Math,
    SafeERC20
} from "../lib/openzeppelin-upgradeable/contracts/token/ERC20/extensions/ERC4626Upgradeable.sol";

/// @title MetaMorpho
/// @author Morpho Labs
/// @custom:contact security@morpho.org
/// @notice ERC4626 compliant vault allowing users to deposit assets to Morpho.
contract MetaMorphoV1_1 is
    ERC4626Upgradeable,
    ...
    IMetaMorphoV1_1StaticTyping
{
    ...
    /// @dev Immigrated to upgradeable version.
    constructor(
        address, /* owner */
        address, /* morpho */
    ...
    function _withdrawable(
        ...
        uint256 availableLiquidity = UtilsLib.min(
            totalSupplyAssets - totalBorrowAssets, ERC20Upgradeable(marketParams.loanToken).balanceOf(address(MORPHO))
        );
